                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Tuyển Sinh Sinh Viên</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Tuyển Sinh Sinh Viên</li>
                                    </ul>
                                </div>
...
<div class="form-group">
<label for="default" class="col-sm-2 control-label">Mã Số Sinh Viên</label>
<div class="col-sm-10">
...
<div class="form-group">
                                                        <label for="date" class="col-sm-2 control-label">Sinh Nhật</label>
                                                        <div class="col-sm-10">
                <input type="date"  name="dob" class="form-control" value="<?php echo htmlentities($result->DOB)?>" id="date">
                                                        </div>
                                                    </div>
<div class="form-group">
<label for="default" class="col-sm-2 control-label">Ngày Đăng Ký: </label>
<div class="col-sm-10">
