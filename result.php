                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-12">
                                    <h2 class="title" align="center">Hệ Thống Quản Lý Điểm Sinh Viên</h2>
                                </div>
                            </div>
                            <!-- /.row -->
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h3 align="center">Chi Tiết Kết Quả Sinh Viên</h3>
                                                    <hr/>
<?php
// code Student Data
$rollid=$_POST['rollid'];
...
{   ?>
<p><b>Họ Tên Sinh Viên :</b> <?php echo htmlentities($row->StudentName);?></p>
<p><b>Mã Số Sinh Viên :</b> <?php echo htmlentities($row->RollId);?>
<p><b>Lớp:</b> <?php echo htmlentities($row->ClassName);?>(<?php echo htmlentities($row->Section);?>)
<?php }
...
?>
<tr>
<th scope="row" colspan="2" style="text-align: center">Tổng Điểm</th>
<td style="text-align: center"><b><?php echo htmlentities($totlcount); ?></b> trên <b><?php echo htmlentities($outof=($cnt-1)*10); ?></b></td>
                                                        </tr>
<tr>
<th scope="row" colspan="2" style="text-align: center">Phần Trăm</th>           
...
<div class="alert alert-warning left-icon-alert" role="alert">
                                            <strong>Thông báo!</strong> Kết quả của bạn chưa được công bố<div class=""></div>
 <?php }
?>
                                        </div>
 <?php 
