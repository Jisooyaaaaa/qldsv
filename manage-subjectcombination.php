...
<html lang="en">
    <head>
        ...
        <title>Admin| Quản Lý Kết Hợp Môn</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Quản Lý Kết Hợp Môn</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li> Môn Học</li>
            							<li class="active">Quản Lý Kết Hợp Môn</li>
            						</ul>
                                </div>
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Xem Thông Tin Môn Học Đã Kết Hợp</h5>
                                                </div>
                                            </div>
<?php if($msg){?>
...
<tr>
 <td><?php echo htmlentities($cnt);?></td>
                                                            <td><?php echo htmlentities($result->ClassName);?> &nbsp; Nhóm<?php echo htmlentities($result->Section);?></td>
...
<?php if($stts=='0')
{ ?>
<a href="manage-subjectcombination.php?acid=<?php echo htmlentities($result->scid);?>" onclick="confirm('Bạn có thực sự muốn kích hoạt môn học này không?');"><i class="fa fa-check" title="Acticvate Record"></i> </a><?php } else {?>

<a href="manage-subjectcombination.php?did=<?php echo htmlentities($result->scid);?>" onclick="confirm('Bạn có thực sự muốn vô hiệu hóa môn học này không?');"><i class="fa fa-times" title="Deactivate Record"></i> </a>
<?php }?>
</td>
</tr>
<?php $cnt=$cnt+1;}} ?>
