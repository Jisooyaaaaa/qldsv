...
if($lastInsertId)
{
$msg="Nhập thông tin sinh viên thành công";
}
else 
{
...
<html lang="en">
    <head>
        ...
        <title>Admin| Tiếp Nhận Sinh Viên </title>
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Tiếp Nhận Sinh Viên</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Tiếp Nhận Sinh Viên</li>
                                    </ul>
                                </div>
