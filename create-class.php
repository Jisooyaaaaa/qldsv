...
if($lastInsertId)
{
$msg="Tạo lớp học phần thành công.";
}
else 
{
...
<html lang="en">
    <head>
        ...
        <title> Admin| Tạo Lớp Học Phần</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Tạo Lớp Học Phần</h2>
                                </div>
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <form method="post">
                                                    <div class="form-group has-success">
                                                       ...
                                                       <div class="form-group has-success">
                                                        <label for="success" class="control-label">Tên Lớp Bằng Số</label>
                                                        <div class="">
                                                            <input type="number" name="classnamenumeric" required="required" class="form-control" id="success">
                                                            <span class="help-block">Ví dụ: 1,2,4,5,...</span>
                                                        </div>
                                                    </div>
                                                     <div class="form-group has-success">
                                                        <label for="success" class="control-label">Nhóm</label>
                                                        <div class="">
