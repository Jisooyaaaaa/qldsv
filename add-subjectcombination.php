...
if($lastInsertId)
{
$msg="Kết hợp môn học thành công.";
}
else 
{
...
<html lang="en">
    <head>
        ...
        <title>Admin| Kết Hợp Môn Và Lớp </title>
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title"> Kết Hợp Lớp Và Môn Học </h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li> Môn Học </li>
                                        <li class="active">Thêm Môn Và Lớp Cần Kết Hợp</li>
                                    </ul>
                                </div>
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Thêm Môn Và Lớp Cần Kết Hợp</h5>
                                                </div>
                                            </div>
...
<?php }} ?>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-sm-offset-2 col-sm-10">
                                                            <button type="submit" name="submit" class="btn btn-primary">Thêm vào</button>
                                                        </div>
                                                    </div>
                                                </form>
